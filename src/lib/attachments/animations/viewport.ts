import { animate, inView as inViewMotion, stagger, type AnimationPlaybackControlsWithThen, type MotionNodeOptions } from "motion";
import type { Attachment } from "svelte/attachments";

const animationList = {
  'slideUpFadeIn': {
    "entry": {
      initialCSS: "transform: translateY(100px);", // not the prettiest
      transforms: { opacity: [0, 1], y: [0, -100] },
